...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("social", "Manage social automation drafts, previews, approvals, and audit",
               "Tools & Skills", args_hint="[status|propose|preview|approve|why|run-once]",
               subcommands=("status", "migrate", "propose", "list", "preview", "why", "approve", "run-once")),
